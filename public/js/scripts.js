    ...
    this.custom = function (msg, title, buttons, fun, class_name) {
        ...
        for (var button in buttons) {
            ...
            if (typeof buttons[button] == 'object') {
                ...
                var b = {value: buttons[button], 'class': ''
                };
            }
            var h = '';
            for (var n in b) {
...
// defined popup box with OK button
    ...
    this.common = function (msg, title) {
        if (typeof title == 'string') {
            $(this.box).find('.head').html(title);
        }
        if (typeof msg == 'string') {
            $(this.box).find('.body').html(msg);
        }
        return this.show();
    };
                ...
                try {
                    ...
                    switch (datao.cmd) {
                        ...
                        case 'popup' :
                            ...
                            switch (datao.type) {
                                case 'info':
                                    ccpopup.info(datao.msg);
                                    break;
                                default:
                                    ccpopup.error(datao.msg);
                                    break;
                            }
                            return true;
                            break;
            ...
            return this.each(function () {
                ...
                $("> li > ul", obj).each(function (i) {
                    ...
                    $("li > a", $(this)).each(function (i) {
                        $(this).click(function () {
                            $("li", obj).removeClass('over dropped');
                        });
                    });
    ...
    $.addFlex = function (t, p) {
        ...
        p = $.extend({
            ...
            onStartLoading: function () {
                busy_msg_show();
            },              // poczatek czytania danych
            onEndLoading: function () {
                busy_msg_hide();
            },                // dane odczytane z serwera
            onDataDisplayed: function (total_nr) {
            },                    // datane zosatly wyswietlone
            contextMenu: false,
            contextMenuIconPath: '',
            ...
            onSingleItemSelected: function (id, row_data) {
            },            // in single mode send final item state
            onSingleItemUnSelected: function (id, row_data) {
            },          // in single mode send final item state
            onItemSelected: function (id, row_data) {
            },
            onItemClicked: function (id, row_data) {
            },                   // row clicked
            ...
            templStatusline: {
                0: {'pager': [   '<div class="pGroup"> ',
                    ...
                    'pageBox': [   '<div class="pBox pButton pButtonW"><span><span>-=1=-</span></span></div>'],
                    'pageBoxActive': [   '<div class="pBox pButton pButtonW active"><span><span>-=1=-</span></span></div>']
                },
                1: {'pager': [   '<div class="pGroup"> ',
                    '<div class="pFirst pButton"><span></span></div>',
                    '<div class="pPrev pButton"><span></span></div> ',
                    '</div> ',
                    '<div class="btnseparator"></div> ',
        ...
        var g = {
            ...
            addData: function (data) { //parse data
                ...
                if (p.total == 0) {   // result empty
                    ...
                    try {
                        p.onDataDisplayed.call(self, p.total);
                    } catch (e) {
                    }
                            ...
                            if (p.contextMenu == true) {
                                ...
                                $.each(row.menu, function (menu_i, menu_row) {
                                    if (menu_row.name == '---') {
                                        ...
                                        menu1[menu_i][menu_row.name]['onclick'] = function (menuItem, menu) {
                                            try {
                                                p.onContextMenuClick.call(self, row.id, menu_row.action, row.cell, menuItem, menu);
                                            } catch (e) {
                                            }
                                        };
                    ...
                    function () {
                        $(this)
                            ...
                            function (e) {
                                ...
                                try {
                                    p.onItemClicked.call(self, $(this).attr('id').substr(3), row_data);
                                } catch (e) {
                                }
                                if ($(this).hasClass('trSelected') == false) {
                                    try {
                                        p.onItemSelected.call(self, $(this).attr('id').substr(3), row_data);
                                    } catch (e) {
                                    }
                                    if (p.singleSelect) {
                                        try {
                                            p.onSingleItemSelected.call(self, $(this).attr('id').substr(3), row_data);
                                        } catch (e) {
                                        }
                                    }
                                } else {
                                    try {
                                        p.onItemUnSelected.call(self, $(this).attr('id').substr(3), row_data);
                                    } catch (e) {
                                    }
                                    if (p.singleSelect) {
                                        try {
                                            p.onSingleItemUnSelected.call(self, $(this).attr('id').substr(3), row_data);
                                        } catch (e) {
                                        }
                                    }
                                }
...
(function ($) {
    var DatePicker = function () {
        var ids = {},
            ...
            defaults = {
                ...
                onShow: function () {
                    return true;
                },       // return false to prevent show the window
                onBeforeShow: function () {
                    return true;
                }, // function result is scipped
                onHide: function () {
                    return true;
                },       // return false to prevent hide the window
    ...
    if (typeof locale.objects == 'undefined') {
        locale.objects = {};
    }
...
(function ($) {
    $.contextMenu = {
        ...
        createMenu: function (menu, cmenu) {
            ...
            var $t = $('<table class="context-menu-main" cellspacing=0 cellpadding=0></table>').click(function () {
                cmenu.hide();
                return false;
