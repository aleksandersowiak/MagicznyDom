...
*/
(function(n,u,r){n.fn.paging=function(y,z){var s=this,b={setOptions:function(a){b.a=n.extend(b.a||{lapping:0,perpage:5,page:1,refresh:{interval:5,url:null},format:"",lock:!1,onFormat:function(){},onSelect:function(){return!0},onRefresh:function(){}},a||{});b.a.lapping|=0;b.a.perpage|=0;null!==b.a.page&&(b.a.page|=0);1>b.a.perpage&&(b.a.perpage=5);b.interval&&u.clearInterval(b.interval);b.a.refresh.url&&(b.interval=u.setInterval(function(){n.ajax({url:b.a.refresh.url,success:function(a){if("string"===
