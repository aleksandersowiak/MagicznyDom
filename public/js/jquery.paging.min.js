...
(function (n, u, r) {
    n.fn.paging = function (y, z) {
        var s = this, b = {setOptions: function (a) {
            b.a = n.extend(b.a || {lapping: 0, perpage: 5, page: 1, refresh: {interval: 5, url: null}, format: "", lock: !1, onFormat: function () {
            }, onSelect: function () {
                return!0
            }, onRefresh: function () {
            }}, a || {});
            ...
            b.format = function (a) {
                ...
                {e: "block", h: 0, c: 0}, h = 0) : (e.d[e.d.length] = {e: n[c], h: g, c: r === f[c] ? f[c] = 1 : ++f[c]}, "q" === c ? ++e.j : "p" === c && ++e.i);
                return e
            }(b.a.format);
            return b
            ...
            d = {number: m, lapping: q, pages: c, perpage: g.perpage, page: a, slice: [(k = a * (g.perpage - q) + q) - g.perpage, Math.min(k, m)]};
            for (p = ""; ++t < x;) {
                l = f.d[t];
                k = w >> l.h & 1;
                switch (l.e) {
            ...
            }), b.k = g.onSelect.call({number: m,
                lapping: q, pages: c, slice: d.slice}, a, s));
            return b
        }};
